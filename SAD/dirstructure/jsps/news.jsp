...
<div class="row bg-info border" id="row1" style="height: 220px">
    ...
    <div class="col-sm-4 border" style="height: 100%"> news3 </div>
        ...
        <div class="row bg-primary border" id="row2" style="height: 220px">
        ...
        <div class="row bg-success border" id="row3" style="height: 200px">
